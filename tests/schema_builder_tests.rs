...
mod schema_builder_tests {
    ...
    fn test_object_schema_builder() {
        let schema = SchemaBuilder::object()
            ...
            .property("name", json!({"type": "string", "description": "The name"}), true)
            .property("age", json!({"type": "integer", "description": "The age"}), true)
            .property("email", json!({"type": "string", "description": "Email address"}), false)
            .build();
    ...
    fn test_property_with_example() {
        let schema = SchemaBuilder::object()
            .property("name", json!({"type": "string", "example": "John Doe"}), true)
