...
mod llm_integration_tests {
    ...
    async fn test_openai_generate_struct() {
        ...
        let movie: Movie = client.generate_struct(prompt).await.expect("Failed to generate movie info");
    ...
    fn test_movie_schema_generation() {
        ...
        assert_eq!(properties["year"]["description"], "Year the movie was released");
