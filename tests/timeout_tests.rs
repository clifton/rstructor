...
mod timeout_tests {
    ...
    // 1. Very short timeouts cause timeout errors (test_openai_timeout_configuration, test_anthropic_timeout_configuration, test_grok_timeout_configuration)
    // 2. Timeout can be configured via builder pattern (test_openai_timeout_chaining, test_anthropic_timeout_chaining, test_grok_timeout_chaining)
    // 3. Default behavior works without timeout (test_openai_no_timeout_default, test_anthropic_no_timeout_default, test_grok_no_timeout_default)
    //
